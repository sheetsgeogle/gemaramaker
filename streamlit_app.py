...
# If Daf Yomi is not selected, show Gemara Type and Mesechta options
if not daf_yomi:
...
# If Daf Yomi is selected, show the Daf Yomi PDF link
if daf_yomi:
    daf_yomi_url = "https://daf-yomi.com/Data/UploadedFiles/DY_Page/3276.pdf"
    # Create a button to open the Daf Yomi PDF URL
    st.markdown(
        f"""
        <a href="{daf_yomi_url}" target="_blank" style="
            display: inline-block;
            padding: 10px 20px;
            font-size: 16px;
            color: black;
